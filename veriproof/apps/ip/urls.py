...
urlpatterns = [
    ...
    path("ip/<uuid:asset_id>/sponsored-usdc/settle", views_api.settle_sponsored_usdc_payment, name="api-sponsored-usdc-settle"),
    path("ip/<uuid:asset_id>/agent-sponsored-usdc", views_api.create_agent_sponsored_usdc_payment, name="api-agent-sponsored-usdc"),
    path("ip/<uuid:asset_id>/agent-sponsored-usdc/settle", views_api.settle_agent_sponsored_usdc_payment, name="api-agent-sponsored-usdc-settle"),
