...
class SalesService:
    ...
    def _sales(self, creator: Any) -> Any:
        ...
        from apps.settlement.models import License
        return License.objects.filter(asset__creator=creator)
    ...
    def _summary_dict(summary: SalesSummary) -> dict[str, Any]:
        ...
        return {"sale_count": summary.sale_count, "gross_usdc": str(summary.gross_usdc), "platform_fee_bps": summary.platform_fee_bps, "platform_fee_usdc": str(summary.platform_fee_usdc), "creator_proceeds_usdc": str(summary.creator_proceeds_usdc)}
